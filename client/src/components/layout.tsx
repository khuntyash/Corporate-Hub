      ...
      <div className="bg-primary text-primary-foreground py-2 text-xs hidden md:block">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex gap-6">
            <span>Global HQ: Zurich, Switzerland</span>
            <span>Support: +41 22 555 0199</span>
            <span>Email: trade@duallife-chem.com</span>
          </div>
          <div className="flex gap-4">
            <Link href="/infrastructure" className="hover:text-gold transition-colors">Infrastructure</Link>
            ...
            <Sheet>
              ...
              <SheetContent side="right">
                <div className="flex flex-col gap-6 mt-6">
                  ...
                  <Link href="/infrastructure" className="text-lg font-medium">Infrastructure</Link>
                  ...
                  {user ? (
                    ...
                    <>
                      ...
                      <Link href="/auth?tab=register">
                        <Button className="w-full bg-primary">Partner With Us</Button>
                      </Link>
                    </>
                  )}
                </div>
      ...
      <footer className="bg-primary text-primary-foreground pt-16 pb-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h4 className="font-bold text-gold mb-4 uppercase tracking-wider text-sm">Products</h4>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li><Link href="/products" className="hover:text-white transition-colors">Industrial Acids</Link></li>
                <li><Link href="/products" className="hover:text-white transition-colors">Solvents</Link></li>
                <li><Link href="/products" className="hover:text-white transition-colors">Alkalis</Link></li>
                <li><Link href="/products" className="hover:text-white transition-colors">Pigments</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300 text-sm">
                ...
                <li>Phone: +41 22 555 0199</li>
                <li>Email: trade@duallife-chem.com</li>
              </ul>
            </div>
          </div>
